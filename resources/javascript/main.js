...
if (document.location.href == 'http://crisgymfitness.ro/galerie' || document.location.href == 'https://crisgymfitness.ro/galerie') {
    ...
    if (screen.width < 1023) {
        ...
        gallery.innerHTML = '<div class="grid-item"><img class="gallery-image" id="2" onclick="showMyImage(this)" src="/resources/photos/gallery/2.jpeg?v=1.5" style="height: 285px; width: 250px;" alt="2" /></div>' +
            ...
            '<div class="grid-item"><img class="gallery-image" id="23" onclick="showMyImage(this)" src="/resources/photos/gallery/23.jpeg?v=1.5" style="height: 285px; width: 250px;" alt="23" /></div>' +
        ...
        gallery.innerHTML = '<div class="grid-item"> <a href="/resources/photos/gallery/2.jpeg?v=1.5"><img class="gallery-image" id="2" src=" /resources/photos/gallery/2.jpeg?v=1.5" style="height: 285px; width: 250px;" alt="2"></a> </div>' +
            ...
            '<div class="grid-item"> <a href="/resources/photos/gallery/23.jpeg?v=1.5"><img class="gallery-image" id="23" src=" /resources/photos/gallery/23.jpeg?v=1.5" style="height: 285px; width: 250px;" alt="23"></a> </div>' +
